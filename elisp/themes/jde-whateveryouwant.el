(defun color-theme-jde-whateveryouwant ()
  "Color theme by Fabien Penso, created 2002-05-02. Modified by jde 201405"
  (interactive)
  (color-theme-install
   '(color-theme-jde-whateveryouwant
     ...
     (highlight ((t (:background "ForestGreen" :foreground "white"))))
